...
export function FeaturesOverview() {
  return (
    <section className="bg-teal-50/50 py-20 px-6 lg:px-16">
      <div className="max-w-7xl mx-auto text-center">
        <p className="text-[10px] font-extrabold tracking-widest text-teal-600 uppercase mb-3">
          4 Fitur Unggulan
        </p>
        <h2 className="font-black text-3xl lg:text-4xl text-teal-950 tracking-tight mb-4">
          Dirancang untuk Perjalananmu
        </h2>
        <p className="text-base text-teal-700/80 font-serif max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            <span className="inline-block px-3 py-1 rounded-full bg-teal-50 text-teal-700 text-[10px] font-extrabold tracking-widest mb-6">
              01 · SAFE DIARY
            </span>
            <h2 className="text-3xl lg:text-4xl font-black text-teal-950 tracking-tight mb-6">
              Diary yang Benar-Benar Mengerti Perasaanmu
            </h2>
            <p className="text-teal-700/80 leading-relaxed font-serif mb-8 text-base/7">
            ...
            <ul className="space-y-4 mb-8 text-sm text-teal-900 font-medium">
              {[
            ...
            <Link href="/diary">
              <Button
                size="lg"
                className="bg-teal-700 hover:bg-teal-800 text-white rounded-xl gap-2 font-bold px-8 h-12"
              >
          ...
          <div className="flex-1 w-full relative">
            <div className="relative rounded-3xl bg-teal-50 border-2 border-teal-100 p-8 flex flex-col gap-4 shadow-xl">
              ...
              <div className="w-full bg-teal-50 text-teal-950 border border-teal-100 rounded-t-2xl rounded-br-2xl p-4 text-sm font-serif max-w-[85%] shadow-sm">
              ...
              <div className="mt-4 pt-4 border-t border-teal-200/50 flex gap-2">
                <div className="flex-1 bg-white border border-teal-100 rounded-xl px-4 py-3 text-sm text-teal-700/50 flex items-center">
                  Ceritakan harimu...
                </div>
                <div className="w-12 h-12 bg-teal-700 text-white rounded-xl flex items-center justify-center shrink-0">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          ...
          <div className="flex-1 w-full">
            <div className="bg-teal-900 rounded-3xl p-8 shadow-xl text-white relative overflow-hidden border border-teal-800">
              ...
              <h3 className="text-xl font-medium font-serif leading-relaxed mb-10 text-teal-50">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl flex items-center gap-4 transition-all font-medium text-sm border-2 ${
                    selectedOption === null
                      ? "bg-white text-teal-950 border-transparent hover:bg-teal-50"
                      : selectedOption === 0
                        ? "bg-emerald-50 text-emerald-900 border-emerald-500 shadow-sm"
                        : "bg-white text-teal-950 opacity-60 border-transparent"
                  }`}
                >
                  <div
...
export function FeaturesQuote() {
  return (
    <section className="py-24 px-6 lg:px-16 bg-teal-950 text-white text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <p className="text-teal-200/80 font-serif tracking-widest text-sm">
...
export function FeaturesPrivacy() {
  return (
    <section className="bg-white py-24 px-6 lg:px-16 border-t border-teal-50">
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <p className="text-teal-700/80 leading-relaxed font-serif mb-16 text-base/7 max-w-2xl">
          Orang tua mendapatkan laporan perkembangan umum setiap minggu — tanpa
          melihat isi diary pribadi anak.
        </p>

        {/* Weekly Report Mockup */}
        <div className="w-full max-w-3xl border-2 border-teal-50 rounded-3xl overflow-hidden shadow-lg bg-white text-left">
          <div className="bg-teal-50/50 p-6 border-b border-teal-50 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-teal-700 text-white rounded-xl flex items-center justify-center">
            ...
            <div className="hidden sm:flex bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-xs font-bold items-center gap-1">
              <CheckCircle2 className="w-3 h-3" /> Terverifikasi
            </div>
          </div>
          <div className="p-8 lg:p-10 space-y-6">
            <p className="text-xs font-medium text-teal-600/60 tracking-wider">
              Rabu, 4 April 2026 · Laporan #12
            </p>
            <h3 className="text-2xl font-black text-teal-950">
              Perkembangan Clarisya — Minggu Ini
            </h3>
            <p className="text-sm/6 text-teal-800/80 font-serif">
            ...
            <div className="bg-teal-50/80 border border-teal-100 rounded-2xl p-5 flex gap-4 mt-8">
              <CheckCircle2 className="w-5 h-5 text-teal-600 shrink-0 mt-0.5" />
              <p className="text-xs/5 text-teal-800/70 font-medium">
  ...
  return (
    <section className="bg-teal-900 py-24 px-6 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-base lg:text-lg text-white/70 font-serif leading-relaxed mb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/register">
            <Button
              size="lg"
              className="h-14 px-8 rounded-2xl bg-white hover:bg-teal-50 text-teal-900 font-extrabold w-full sm:w-auto"
            >
          ...
          <Link href="/pricing">
            <Button
              size="lg"
              variant="outline"
              className="h-14 px-8 rounded-2xl border-2 border-teal-500 hover:bg-teal-800 text-teal-500 font-bold w-full sm:w-auto"
            >
              Lihat Harga
            </Button>
          </Link>
